...
namespace Text12_2
{
    public partial class Form3 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //clientSocket = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
            //clientSocket.Connect(new IPEndPoint(ip, 8885));
            //Form1.clientSocket2 = Form1.serverSocket.Accept();
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            try
            {
                clientSocket.Connect(new IPEndPoint(ip, 8885));
                Form1.clientSocket2 = Form1.serverSocket.Accept();
                Form1.clientSocket2.Send(Encoding.ASCII.GetBytes("Welcome to login! Client!"));
                textBox1.Text = "成功连接服务！ 本机地址：端点(" + Form1.clientSocket2.RemoteEndPoint.ToString() + ")";
